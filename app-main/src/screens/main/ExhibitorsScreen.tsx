                            ...
                            <View style={styles.cardBody}>
                                ...
                                {ex.website && (
                                    <TouchableOpacity onPress={() => Linking.openURL(ex.website!)} style={styles.websiteRow}>
                                       <Ionicons name="link-outline" size={14} color="#5A4485" />
...
const styles = StyleSheet.create({
    ...
    boothBadge: {
        width: 44, height: 44, borderRadius: 12, backgroundColor: '#f4f1f9',
        justifyContent: 'center', alignItems: 'center', marginRight: 14,
    },
    boothText: { fontSize: 13, fontWeight: '800', color: '#5A4485' },
    cardBody: { flex: 1 },
    exhibitorName: { fontSize: 16, fontWeight: '800', color: '#1a1a1a', marginBottom: 2 },
    exhibitorCategory: { fontSize: 12, fontWeight: '600', color: '#8F2451', marginBottom: 6 },
    exhibitorDescription: { fontSize: 13, color: '#666', lineHeight: 18 },
    websiteRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 8 },
    websiteText: { fontSize: 13, fontWeight: '600', color: '#5A4485' },
});