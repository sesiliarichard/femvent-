        ...
        <SafeAreaView style={styles.container} edges={['top']}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    ...
                    <Ionicons name="person-outline" size={20} color="#5A4485" />
                        <TextInput
                            style={styles.input}
                    ...
                    <View style={styles.inputContainer}>
                    <Ionicons name="call-outline" size={20} color="#5A4485" />
                        <TextInput
                            style={styles.input}
                    ...
                    <Ionicons name="document-text-outline" size={20} color="#5A4485" style={styles.bioIcon} />
                        <TextInput
