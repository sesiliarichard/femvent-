 ...
 * Logs to both console (development) and Firestore (production audit trail)
 */
...
class Logger {
  ...
  constructor(app: string, platform: 'web' | 'mobile' | 'server' = 'web') {
    ...
    // Enable Firestore logging in production or when explicitly enabled
...
export const logger = new Logger('hostdweb', 'web');
