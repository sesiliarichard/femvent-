...
export default function EditAboutPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (error) throw error;
      alert('About page saved! Note: this also updates the Home page, since they share content.');
    } catch (err) {
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-gray-900">Edit About Page</h1>
        <p className="text-sm text-gray-500 mt-1">
          Update the text and images shown on femvents.netlify.app/about. This content is shared with the Home page.
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 mb-5 overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            ...
            <textarea value={content.heroDescription} onChange={(e) => setContent({ ...content, heroDescription: e.target.value })} rows={4} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
          <ImageUploadWidget
            label="Hero Image"
          ...
          <div>
            ...
            <input type="text" value={content.heroImageAlt} onChange={(e) => setContent({ ...content, heroImageAlt: e.target.value })} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 mb-5 overflow-hidden">
        ...
        <div className="p-6 space-y-5">
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-2">Title</label>
            <input type="text" value={content.moreThanTitle} onChange={(e) => setContent({ ...content, moreThanTitle: e.target.value })} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
          <div>
            <label className="block text-sm font-semibold text-gray-900 mb-2">Description</label>
            <textarea value={content.moreThanDescription} onChange={(e) => setContent({ ...content, moreThanDescription: e.target.value })} rows={3} className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
        </div>
      </div>
