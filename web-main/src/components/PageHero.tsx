  ...
  return (
    <div className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-16">
      <section className="relative overflow-hidden bg-gradient-to-br from-rose-100 via-purple-50 to-orange-50 py-16 shadow-none">
        <div className="pointer-events-none absolute -top-24 -right-24 w-96 h-96 bg-gradient-to-br from-rose-400/20 to-purple-400/20 rounded-full blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -left-24 w-96 h-96 bg-gradient-to-br from-orange-400/20 to-pink-400/20 rounded-full blur-3xl" />
